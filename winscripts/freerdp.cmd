...
@REM copy %libspath%\SDL2-install\bin\SDL2.dll %freerdppath%\freerdpinstall\bin
@REM copy %libspath%\SDL3-install\bin\SDL3.dll %freerdppath%\freerdpinstall\bin
@REM copy %libspath%\SDL3TTF-install\bin\SDL3_ttf.dll %freerdppath%\freerdpinstall\bin
@REM copy %libspath%\SDL2IMAGE-install\bin\SDL2_image.dll %freerdppath%\freerdpinstall\bin
@REM copy %libspath%\SDL2TTF-install\bin\SDL2_ttf.dll %freerdppath%\freerdpinstall\bin

copy %libspath%\uriparser-install\bin\uriparser.dll %freerdppath%\freerdpinstall\bin

@REM copy %libspath%\uriparser-install\bin\uriparse.exe %freerdppath%\freerdpinstall\bin
...
@REM copy %libspath%\libusb-install\bin\libusb-1.0.dll %freerdppath%\freerdpinstall\bin
